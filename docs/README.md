...
These pages define the tracked evidence, catalog, and workflow contracts. If a
contribution needs repository-level rules, see
...
- [Automated and AI-assisted contributions](ai_agents/README.md) - conditional contribution policy.
